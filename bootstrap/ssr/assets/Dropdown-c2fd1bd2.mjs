...
function ApplicationLogo() {
  return /* @__PURE__ */ jsx(Link, { href: route("home"), children: /* @__PURE__ */ jsxs("div", { className: "font-semibold text-2xl", children: [
    /* @__PURE__ */ jsx("span", { className: "text-white", children: "Sign" }),
...
const DropdownLink = ({ className = "", children, ...props }) => {
  return /* @__PURE__ */ jsx(
    ...
    {
      ...props,
      className: "block w-full px-4 py-2 text-left text-sm leading-5 text-gray-500 hover:bg-color-primary/20 focus:outline-none focus:bg-color-primary/20 transition duration-150 ease-in-out " + className,
      children
    }
  );
};
